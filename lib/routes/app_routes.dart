...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/patient/health-tracker-input', builder: (context, state) => const HealthTrackerInputScreen()),
    GoRoute(path: '/patient/health-tracker-dashboard', builder: (context, state) => const HealthTrackerDashboardScreen()),
    GoRoute(path: '/patient/medication-reminder-setup', builder: (context, state) => const MedicationReminderSetupScreen()),
    GoRoute(path: '/patient/medical-records', builder: (context, state) => const MedicalRecordsScreen()),
    GoRoute(path: '/patient/telemedicine-call', builder: (context, state) => const TelemedicineCallScreen()),
    GoRoute(path: '/doctor/home', builder: (context, state) => const DoctorHomeScreen()),
    GoRoute(path: '/doctor/profile-setup', builder: (context, state) => const DoctorProfileSetupScreen()),
    GoRoute(path: '/doctor/profile', builder: (context, state) => const DoctorProfileViewScreen()),
    GoRoute(path: '/doctor/appointment-management', builder: (context, state) => const AppointmentManagementScreen()),
    GoRoute(path: '/doctor/patient-details', builder: (context, state) => const PatientDetailsScreen()),
    GoRoute(path: '/doctor/telemedicine-consultation', builder: (context, state) => const TelemedicineConsultationScreen()),
    GoRoute(path: '/admin/dashboard', builder: (context, state) => const AdminDashboardScreen()),
    GoRoute(path: '/admin/user-management', builder: (context, state) => const UserManagementScreen()),
    GoRoute(path: '/admin/content-management', builder: (context, state) => const ContentManagementScreen()),
    GoRoute(path: '/settings', builder: (context, state) => const SettingsScreen()),
    GoRoute(path: '/support', builder: (context, state) => const SupportScreen()),
  ],
  redirect: (context, state) {
    final userProvider = Provider.of<UserProvider>(context, listen: false);
    if (userProvider.role == 'guest' && state.uri.toString() != '/splash' && state.uri.toString() != '/login' && state.uri.toString() != '/signup' && state.uri.toString() != '/forgot-password' && state.uri.toString() != '/otp-verification') {
      return '/login';
    }
    return null;
  },
